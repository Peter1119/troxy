...
42   09:55:13 GET     pedia.watcha.com        /api/users/17ov.../ratings   401     152b   30ms
43   09:55:13 POST    pedia.watcha.com        /api/users                   200     840b   371ms
```

상세 출력 (`troxy flow 42`):
```
── Request ──────────────────────────────
GET https://pedia.watcha.com/api/users/17ovVJlDr1vzy/ratings/2026/4
