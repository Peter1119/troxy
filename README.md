...
```bash
troxy flows                        # flow 목록
troxy flows -d watcha              # 도메인 필터 (부분 매칭)
troxy flows -s 401                 # 상태코드 필터
